...
public class BluetoothZoomain extends Activity {
    //EditText edit2;
    Button btnA;
    TextView textResult;
    int num2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        textResult.setText("총 적립금액 : " + Result);
            ...
            case MESSAGE_READ:
              ...
              try{
                ...
                int number = Integer.parseInt(readMessage);
                    if(number == 1) {
                        num2 = 10;
                        mConversationArrayAdapter.add("가락지점 편의점에서 10원이 적립되었습니다.");
                      ...
                      num2 = 50;
                      mConversationArrayAdapter.add("가락지점 편의점에서 50원이 적립되었습니다.");
                      Toast.makeText(getApplicationContext(), "50원이 적립 되었습니다.", Toast.LENGTH_SHORT).show();
                      Result = num2 + Result;
                      textResult.setText("총 적립금액 : " + Result);
                      num2 = 0;
                  }
                      ...
                      num2 = 100;
                      mConversationArrayAdapter.add("가락지점 편의점에서 100원이 적립되었습니다.");
                      Toast.makeText(getApplicationContext(), "100원이 적립 되었습니다.", Toast.LENGTH_SHORT).show();
                      Result = num2 + Result;
                      textResult.setText("총 적립금액 : " + Result);
                      num2 = 0;
                      ...
                      num2 = 500;
                      mConversationArrayAdapter.add("가락지점 편의점에서 500원이 적립되었습니다.");
                      Toast.makeText(getApplicationContext(), "500원이 적립 되었습니다.", Toast.LENGTH_SHORT).show();
                      Result = num2 + Result;
                      textResult.setText("총 적립금액 : " + Result);
                      num2 = 0;
                  }
